...
* 23 July 2025:  Dr. Pei Qing and Fan Lingyu published a new paper titled "Exploring affordable and effective pandemic containment measures in lower-income countries with a spatial SEIR model: a case study in South Africa" in *BMC Public Health*. <br><br>
This study develops a spatial Susceptible-Exposed-Infectious-Recovered (SEIR) model to simulate the spread of the SARS-CoV-2 Omicron variant in South Africa. The model integrates statistical data from multiple sources, addressing the common issue of missing inter-city mobility data in low-income countries. The study evaluates the effectiveness of three affordable and feasible containment strategies. The results show that these measures are effective in controlling virus transmission while imposing relatively low socioeconomic costs. This research provides valuable insights for lower-income countries to manage current and future pandemics within existing economic and healthcare constraints.<br>
<a href="https://doi.org/10.1186/s12889-025-23686-0">https://doi.org/10.1186/s12889-025-23686-0</a><br>
